...
#'
#'The defaullt *icc=1* stetting is optimal for genes expressed by many cells (>10-30 cells per sample). The *icc=1* is not recommended for multiple sample analysis. The "icc=0" setting 
#'is optimal for very low expression genes (Counts/cell<0.1). With this in mind I recommend running CntAv() once with default icc="i" and once with icc=0 followed by the analysis 
#'illustrated below.
#
